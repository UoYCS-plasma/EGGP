...
bool matchMutateFuncFYShuffle_unmarkBlue(Morphism *morphism)
{
...
void applyMutateFuncFYShuffle_unmarkBlue(Morphism *morphism, bool record_changes)
{
...
bool fillpotMutateFuncFYShuffle_unmarkBlue(MorphismPot *pot, Morphism *morphism)
{
   if(1 > MutateFuncFYShuffle_host->number_of_nodes || 0 > MutateFuncFYShuffle_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < MutateFuncFYShuffle_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "MutateFuncFYShuffle_unmarkBlue", MutateFuncFYShuffle_host);
